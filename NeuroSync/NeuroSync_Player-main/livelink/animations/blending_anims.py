...
# Play the full animation excluding (blend_in_frames at start) and (blend_out_frames at last)
...
#  Blend the given frames(frame_data) of animation with default_animation_data frame 0
...
#  Blend the starting blend_in_frames of animation with default_animation_data frame 0
...
#  Blend the ending blend_out_frames of animation with default_animation_data frame 0
...
# Blend ending blend_frames of animation with starting blend_frames of animation
...
# Blend ending blend_frames of animation with starting blend_frames of animation, but only in specific dimensions(Blendeshapes)
